...
nonisolated extension LLMClient {
    ...
    static func anthropicStream(session: URLSession, apiKey: String) -> LLMClient {
        LLMClient(
            sendMessage: { _, _ in
                throw LLMError.network("sendMessage not supported by stream client")
            },

                ...
                .toolbar {
                    ...
                    ToolbarItem(placement: .topBarTrailing) {
                        Menu {
                            ...
                            Section(String(localized: "settings.tts.voice")) {
                                ForEach(AzureVoice.presets) { voice in
                                    Button {
                                        ...
                                        if viewStore.speechSettings.voiceName == voice.name {
                            ...
                            Image(systemName: viewStore.speechSettings.autoSpeak ? "speaker.wave.3" : "speaker.wave.2")
                                .font(.title3)
                        }
